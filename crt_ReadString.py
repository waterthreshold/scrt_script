...
def Main():
	...
	#	szCommand += crt.Arguments[i]+" "
	szCommand=crt.Dialog.Prompt("Command","command","ifconfig")
	if not szCommand:
		return 
	...
	os.system ("C:\Users\ERIC2\Documents\clipboard.exe {}".format("szResult"))
	crt.Clipboard.Text=szResult
